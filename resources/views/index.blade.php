  ...
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
      <div class="col-md-7 ftco-animate">
        <h2 class="subheading">Selamat datang di layanan</h2>
        <h1 class="mb-4">Pinjam Ruang Lab dan Bengkel TGP</h1>
                ...
                <div class="form-field">
                  <div class="select-wrap">
                    ...
                    <select name="study_program" id="" class="form-control">
                      ...
                      <option value="teknik-informatika">Desain Grafis (D4)</option>
                      <option value="teknik-multimedia-dan-jaringan">Penerbitan Jurnalistik (D3)</option>
                      <option value="teknik-geomatika">Teknik Grafika (D3)</option>
                      <option value="animasi">Teknologi Industri Cetak kemasan (D4)</option>
                    </select>
                  </div>
                </div>
              </div>
  ...
  <div class="container">
    <div class="row justify-content-center pb-5 mb-3">
      <div class="col-md-7 heading-section text-center ftco-animate">
        <h2 id="tataCaraPeminjaman">Tata Cara Peminjaman</h2>
      </div>
    </div>
    <div class="row ftco-animate">
      <div class="col-md-12 wrap-about">
        <div class="text-center">
          <img style="width: 75%" src="{{ asset('vendor/img/FlowchartV1.png') }}" class="img-fluid" alt="...">
        </div>
      </div>
    </div>
  </div>
...
<section class="ftco-section bg-light">
  <div class="container-fluid px-md-0">
    ...
    <div class="col-md-12 text-center">
      <p><a href="{{ route('rooms') }}" class="btn btn-primary" style="font-size:24px; padding:1em ">Lihat Ruangan</a></p>
    </div>
  </div>
</section>
        ...
        <div class="carousel-testimony owl-carousel">
          <div class="item">
            <div class="testimony-wrap d-flex">
              <div class="user-img" style="background-image: url(vendor/technext/vacation-rental/images/person1.jpg)">
              </div>
              <div class="text pl-4">
                <span class="quote d-flex align-items-center justify-content-center">
                  <i class="fa fa-quote-left"></i>
                </span>
                <p class="name">Rachmadita Dwi Pramesti, M.Ds</p>
                <span>Kepala Lab. Fotografi</span>
                <p class="position">Bidang keahlian: Desain Grafis dan Komunikasi Visual.</p>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="testimony-wrap d-flex">
              <div class="user-img" style="background-image: url(vendor/technext/vacation-rental/images/person2.jpg)">
              </div>
              <div class="text pl-4">
                <span class="quote d-flex align-items-center justify-content-center">
                  <i class="fa fa-quote-left"></i>
                </span>
                <p class="name">Andriyanto, S.E., M.Kom</p>
          ...
          <div class="item">
            <div class="testimony-wrap d-flex">
              <div class="user-img" style="background-image: url(vendor/technext/vacation-rental/images/person3.jpg)">
              </div>
              <div class="text pl-4">
                <span class="quote d-flex align-items-center justify-content-center">
                  <i class="fa fa-quote-left"></i>
                </span>
                <p class="name">Drs. Djony Herfan, M.I.Kom.</p>
                <span>Kepala Lab. Penerbitan</span>
                <p class="position">Bidang keahlian jurnalistik, Ilmu Komunikasi/Reportase Investigasi.</p>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="testimony-wrap d-flex">
              <div class="user-img" style="background-image: url(vendor/technext/vacation-rental/images/person4.jpg)">
              </div>
              <div class="text pl-4">
                <span class="quote d-flex align-items-center justify-content-center">
                  <i class="fa fa-quote-left"></i>
                </span>
                <p class="name">Emmidia Djonaedi S.T, M.T,M.BA</p>
                <span class="position">Kepala Lab. Grafika</span>
                <p class="position">Bidang keahlian: Material dan industri cetak.</p>
              </div>
            </div>
          </div>
        </div>
...
<section id="tentang" class="ftco-section bg-light">
  <div class="container">
    <div class="row no-gutters">
      <div class="col-md-6 wrap-about">
        ...
        <h2>Sejarah</h2>
        <p>Jurusan Teknik Grafika dan penerbitan berdiri tahun 1990, menyiapkan sumber daya manusia menjadi tenaga ahli menengah profesional dan kompeten yang mampu mengisi posisi penyelia atau pelaksana dalam bidang grafika, penerbitan, desain grafis, dan teknologi industri cetak kemasan.</p>
      </div>
      <div class="col-md-6 wrap-about ftco-animate">
        <div class="heading-section">
          <div class="pl-md-5">
            <h2 class="mb-2">Teknik Grafika dan Penerbitan</h2>
          </div>
        </div>
        <div class="pl-md-5">
          ...
          <div class="row">
            <div class="services-2 col-lg-6 d-flex w-100">
              ...
              <div class="media-body pl-3">
                <h3 class="heading">Sarjana Terapan Desain Grafis</h3>
                <p>Program Studi Sarjana Terapan Desain Grafis dirancang untuk menghasilkan lulusan yang memiliki kompetensi untuk menghasilkan produk-produk desain grafis solutif berbasis cetak.</p>
              </div>
            </div>
            <div class="services-2 col-lg-6 d-flex w-100">
              <div class="icon d-flex justify-content-center align-items-center">
              ...
              <div class="media-body pl-3">
                <h3 class="heading">D3 Penerbitan jurnalstik</h3>
                <p>Sebagai salah satu program studi tertua di jurusan Teknik Grafika dan Penerbitan, Program studi ini hadir untuk menghasilkan lulusan yang memiliki pengetahuan, keahlian, dan keterampilan menyiapkan berbagai bentuk karya jurnalistik sesuai dengan kebutuhan industri media.</p>
              </div>
            </div>
            <div class="services-2 col-lg-6 d-flex w-100">
              <div class="icon d-flex justify-content-center align-items-center">
              ...
              <div class="media-body pl-3">
                <h3 class="heading">D3 Teknik Grafika</h3>
                <p>Program Studi Teknik Grafika dirancang sebagai pendidikan vokasi D3 yang mempunyai kurikulum dirancang terintegrasi dengan pengembangan teknologi modern di industri grafika berbasis kommpetensi produksi dan kewirausahaan dibidang industri kreatif.</p>
              </div>
            </div>
            <div class="services-2 col-lg-6 d-flex w-100">
              <div class="icon d-flex justify-content-center align-items-center">
              ...
              <div class="media-body pl-3">
                <h3 class="heading">Sarjana Terapan Teknologi Industri Cetak Kemasan</h3>
                <p>Program Studi Cetak Kemasan Politeknik Negeri Jakarta merupakan salah satu program studi sarjana terapan (D4) dibidang kemasan yang ada dijurusan Teknik Grafika dan Penerbitan.</p>
              </div>
            </div>
          </div>
        </div>
