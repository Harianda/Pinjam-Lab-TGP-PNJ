        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 mb-md-0 mb-4">
                ...
                <ul class="list-unstyled">
                    <li><a href="https://penerimaan.pnj.ac.id/" target="_blank" class="py-1 d-block">Pendaftaran</a></li>
                    <li><a href="https://sim.pnj.ac.id/mahasiswa.pnj.ac.id/halaman_login.php" target="_blank" class="py-1 d-block">Sistem Informasi Akademik</a></li>
                    <li><a href="https://perpustakaan.pnj.ac.id/" target="_blank" class="py-1 d-block">Perpustakaan</a></li>
                    <li><a href="https://jurnal.pnj.ac.id/" target="_blank" class="py-1 d-block">Jurnal</a></li>
                </ul>
            </div>
            <div class="col-md-6 col-lg-3 mb-md-0 mb-4">
                <h2 class="footer-heading">Tag</h2>
                <div class="tagcloud">
                    <a href="#" class="tag-cloud-link">pnj</a>
                    <a href="#" class="tag-cloud-link">pinjam</a>
                    <a href="#" class="tag-cloud-link">ruang</a>
                    <br>
                    <a href="#" class="tag-cloud-link">bengkel</a>
                    <a href="#" class="tag-cloud-link">lab</a>
                </div>
            </div>
            <div class="col-md-6 col-lg-3 mb-md-0 mb-4">
                ...
                <ul class="ftco-footer-social p-0">
                    <li class="ftco-animate"><a href="https://twitter.com/humaspnj?lang=en" target="_blank" data-toggle="tooltip" data-placement="top" title="Twitter"><span class="fa fa-twitter"></span></a></li>
                    {{-- <li class="ftco-animate"><a href="#" data-toggle="tooltip" data-placement="top" title="Facebook"><span class="fa fa-facebook"></span></a></li> --}}
                    <li class="ftco-animate"><a href="https://www.instagram.com/politekniknegerijakarta/?hl=en" target="_blank" data-toggle="tooltip" data-placement="top" title="Instagram"><span class="fa fa-instagram"></span></a></li>
                </ul>
            </div>
        </div>
    </div>
